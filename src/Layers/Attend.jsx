  ...
  return (
    <div>
      ...
      <div className="border-[#0e464f] max-w-screen-sm  mt-7 p-7 m-auto border-2 rounded-3xl">
        <div className="border border-b-[#0e464f] md:flex justify-between items-center w-full pb-3 relative">
        ...
        >
          {/* Avatar image */}
          <div>
            <div className="bg-[#0e464f] mt-7 mb-10 border p-3 pb-10 rounded-xl relative">
              <label className="block font-medium text-gray-300 mb-9 ">
                Upload Profile Picture
              </label>
              <div className="bg-[#052228] mt-4 py-16">
                {/* Drag & Drop File Upload */}
                <div
                  className="bg-[#0e464f] border-[#24a0b5] border-2 p-2 pt-8 w-3/4 md:w-1/3 h-3/4 rounded-2xl absolute top-12 right-9  md:left-1/3 outline-none text-white"
                  onDragOver={(e) => e.preventDefault()}
                  onDrop={handleDrop}
                  onClick={() => document.getElementById("fileUpload").click()}
                >
                   {formData.avatar ? (
                    <img src={formData.avatar} className="text-center break-words px-2">{formData.avatar}</img>
        ) : (
          ...
          {/* Underline */}
          <div className="border-2 border-b-[#07373f] w-full"></div>
          ...
          <div className="relative">
            ...
            />
            <img src='' alt="" className="absolute top-11 left-3 " />
            {errors.email && (
